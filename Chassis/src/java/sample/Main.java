...
public class Main extends Application {
    ...
    private void readFUNSN() throws ParserConfigurationException, IOException, SAXException, TransformerException {
    ...
    private void readCrateSN() throws ParserConfigurationException, IOException, SAXException, TransformerException {
